...
#            print(gen_imgs.size())
            ...
            g_loss = 0.8 * adversarial_loss(validity, valid) + 0.2 * (auxiliary_loss(pred_aux_hair, gen_hair_id) + 
            ...
            d_real_loss = 0.8 * adversarial_loss(real_pred, valid) + 0.2 * (auxiliary_loss(real_aux_hair, hair_id) + 
            ...
            d_fake_loss = 0.8 * adversarial_loss(fake_pred, fake) + 0.2 * (auxiliary_loss(fake_aux_hair, gen_hair_id) + 
...
#            batch_d_acc.append(d_acc)
        ...
        a = np.mean(np.array(batch_d_acc_hair)+np.array(batch_d_acc_eye)+np.array(batch_d_acc_face)+np.array(batch_d_acc_glasses))
