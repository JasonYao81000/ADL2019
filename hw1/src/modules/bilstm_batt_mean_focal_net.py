...
class BiLstmBattMeanFocalNet(torch.nn.Module):
    """
    Args:
    """
    ...
    def __init__(self, dim_embeddings,
                 similarity='MLP'):
        super(BiLstmBattMeanFocalNet, self).__init__()
        ...
        self.attention_rnn = torch.nn.LSTM((self.hidden_size * 2) * 4, self.hidden_size, self.num_layers, batch_first=True, bidirectional=True)
        ...
        for i, option in enumerate(options.transpose(1, 0)):
            ...
            attention_context_outs, (attention_context_h_n, attention_context_c_n) = self.attention_rnn(
                torch.cat((
                    ...
                    context_outs - attention_context), dim=-1), (h_1, c_1))
            ...
            attention_option_outs, (attention_option_h_n, attention_option_c_n) = self.attention_rnn(
                torch.cat((
                    ...
                    option_outs - attention_option), dim=-1), (h_1, c_1))
