...
class CosAttentionMaxNet(torch.nn.Module):
    """
    Args:
    """
    ...
    def __init__(self, dim_embeddings,
        ...
        super(CosAttentionMaxNet, self).__init__()
    ...
    def forward(self, context, context_lens, options, option_lens):
        ...
        # context_outs_max: tensor of shape (batch, hidden_size * 2)
        ...
        for i, option in enumerate(options.transpose(1, 0)):
            ...
            logit = torch.nn.CosineSimilarity(dim=1)(context_outs_max, attention_option_outs_max)
            logits.append(logit)
