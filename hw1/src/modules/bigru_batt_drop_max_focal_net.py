...
class BiGruBattDropMaxFocalNet(torch.nn.Module):
    """
    Args:
    """
    ...
    def __init__(self, dim_embeddings, dropout_rate=0.2,
                 similarity='MLP'):
        super(BiGruBattDropMaxFocalNet, self).__init__()
    ...
    def forward(self, context, context_lens, options, option_lens):
        ...
        context_key = self.dropout(context_key)
        ...
        for i, option in enumerate(options.transpose(1, 0)):
            ...
            option_query = self.dropout(option_query)
            ...
            attention_context_outs = self.dropout(attention_context_outs)
            ...
            attention_option_outs = self.dropout(attention_option_outs)
