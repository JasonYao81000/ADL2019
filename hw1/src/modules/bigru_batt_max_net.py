...
class BiGruBattMaxNet(torch.nn.Module):
    """
    Args:
    """
    ...
    def __init__(self, dim_embeddings,
        ...
        super(BiGruBattMaxNet, self).__init__()
        ...
        self.attention_rnn = torch.nn.GRU(self.hidden_size * 2, self.hidden_size, self.num_layers, batch_first=True, bidirectional=True)
