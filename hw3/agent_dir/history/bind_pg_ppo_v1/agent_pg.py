...
class AgentPG(Agent):
    ...
    #                    env.render()
                ...
                if epoch % self.display_freq == 0:
                    ...
                    last_reward = int((last_reward/self.display_freq))
                    
                    print('Episode {}/{} \t avg length: {} \t running_reward: {} \t Avg reward: {}'.format(
                            epoch, self.num_episodes, avg_length, last_reward, avg_reward))
                    running_reward = 0
                    avg_length = 0
